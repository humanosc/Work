...
{
    public class CppVersionIncrementorStrategy : VersionIncrementorStrategyBase 
    {
        public CppVersionIncrementorStrategy ()
            : base( "cpp" )
        {
        }
        ...
        public override VersionIncremention Increment ( string path )
        {
            ...
            const string assemblyPattern = "AssemblyTitleAttribute[\\(\"](.*)[\"\\)]";
